...
Unfortunately, many IT providers make the switch from on-premise to cloud and it is not always to the advantage of the customer. That means you often don't have any guarantees that you can continue to stay on-premise, even with competing products that make such claims today.
